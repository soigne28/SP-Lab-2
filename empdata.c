...
// Function to find employees with the same last name
void find_employees_by_last_name_case_sensitive(Employee* employees, int size, const char* last_name) {
    for (int i = 0; i < size; i++) {
...
int main(int argc, char* argv[]) {
    ...
    while (1) {
        ...
        //Option 3
            ...
            printf("Enter employee ID: ");
            scanf("%d", &id);
            printf("Enter employee first name (leave blank to keep current): ");
            getchar(); // Consume newline character from previous input
            fgets(first_name, sizeof(first_name), stdin);
            strtok(first_name, "\n"); // Remove newline character
            printf("Enter employee last name (leave blank to keep current): ");
        ...
        //Option 9
            ...
            printf("Enter employee last name: ");
            scanf("%s", last_name);
            find_employees_by_last_name_case_sensitive(employees, num_employees, last_name);
        }
